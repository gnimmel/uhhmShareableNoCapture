...
class ParticleSphereAnimation extends BaseAnimation {
  ...
  setup() {
    super.setup();
    this.shaderProgram = this.p.loadShader('/text_animations/glsl/basic.vert', '/text_animations/glsl/displace-particle-sphere.frag');
    ...
    this.maxLineWidth = this.p.width * 0.5;
